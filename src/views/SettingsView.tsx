  ...
  return (
    <div className="max-w-5xl mx-auto p-8 pb-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {settings.map((item) => (
          <section key={item.label} className="bg-[#1a1d27]/80 border border-[#2e3245] rounded-2xl p-6">
            <div className="flex items-start gap-4">
              <div className="w-11 h-11 rounded-xl bg-[#242736] border border-[#2e3245] flex items-center justify-center text-white">
